...
async function install (context) {
  ...
  print.warning(`
    ...
    ignite-ir-next has been renamed to ignite-ir-boilerplate.

    Please reference ir-boilerplate in your ignite new command:

        ignite new MyApp -b ir-boilerplate

    This NPM package has been deprecated and will not receive future updates.
